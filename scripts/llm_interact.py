...
def execute_gemini_call(client, model, contents) -> str:
...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            try:
                prompt_final_content = execute_gemini_call(genai_client, GEMINI_MODEL, contents_etapa1)
                print("\n------------------------")
        ...
        while True:
            ...
            try:
                resposta_final_content = execute_gemini_call(genai_client, GEMINI_MODEL, contents_etapa2)
                print("\n------------------------")
