...
from scripts.llm_core import config as actual_core_config_module # Importando o módulo real
...
def test_prompt_user_to_select_doc_invalid_then_valid(mock_input: MagicMock, capsys):
    ...
    mock_input.side_effect = ["invalid", "0", "3", "1"] # Invalid, too low, too high, then valid
